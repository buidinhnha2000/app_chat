                        ...
                        Padding(
                          ...
                          child: Text(
                            ...
                            style: context.textTheme.bodyMedium
                                ?.copyWith(color: context.theme.colorScheme.background.withOpacity(0.6), fontWeight: FontWeight.w600),
                          ),
                        ),
                      ],
                    )
                    ...
                    children: [
                          ...
                          BottomSheetChat.show(
                            ...
                            child: HomeChatUserBottomSheet(
                              ...
                              onDelete: () async {
                                ...
                                await Provider.of<ChatProvider>(context, listen: false).deleteMessage(idMessage: messages?[index].id ?? '');
                              },
                            ),
                          );
                        },
                      ...
                      showTime == true
                          ? Padding(
                              ...
                              child: Text(
                                timeMinute,
                                style: context.textTheme.bodySmall?.copyWith(color: context.theme.colorScheme.background.withOpacity(0.6)),
                              ),
                            )
                          : const SizedBox.shrink(),
                    ],
